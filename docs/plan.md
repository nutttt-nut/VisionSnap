...
- Phase 2 trackpad workspace input ผ่าน live-apply, 4/5-finger และ crash-restore physical gates แล้ว
- Multi-monitor และ demo reliability 9/10 ยัง **UNVERIFIED**
- แผนต่อ: demo reliability + recording asset; multi-monitor ยังอยู่นอก scope
...
- [x] Trackpad workspace input — 4 นิ้วสลับ Desktop + 5 นิ้ว Mission Control, lifecycle restore แบบ crash-safe
